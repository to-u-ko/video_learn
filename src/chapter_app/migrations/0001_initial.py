# Generated by Django 3.2.23 on 2024-01-10 07:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_path', models.FileField(upload_to=chapter_app.models.Video.video_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('summary_text', mdeditor.fields.MDTextField(default='## 要約生成中')),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chapter_app.video')),
            ],
        ),
        migrations.CreateModel(
            name='Chapter',
